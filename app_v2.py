...
def update_company_data(company_name, company_website, kyb_data, scraped_data):
    """Update or add company data to the database"""
    try:
        # Load existing database
        df = pd.read_csv("knowYourAi - Company Details.csv")
        
        # Prepare new data matching the existing columns
        new_data = {
            'Company Name': company_name,
            'Website': company_website,
            'Industry': kyb_data.get('industry', 'N/A') + ' [Generated by Groq LLM]',
            'Headquarters': kyb_data.get('headquarters', 'N/A') + ' [Generated by Groq LLM]',
            'Founding Year': kyb_data.get('founding_year', 'N/A') + ' [Generated by Groq LLM]',
            'No.Employees': kyb_data.get('employees', 'N/A') + ' [Generated by Groq LLM]',
            'Funding Raised': kyb_data.get('funding', 'N/A') + ' [Generated by Groq LLM]',
            'Revenue': kyb_data.get('revenue', 'N/A') + ' [Generated by Groq LLM]',
            'Valuation': kyb_data.get('valuation', 'N/A') + ' [Generated by Groq LLM]',
            'Company Description': scraped_data.get('about_info', 'N/A') + f' [Scraped from {company_website}]',
            'Founders & LinkedIn URLs': kyb_data.get('founders', 'N/A') + ' [Generated by Groq LLM]',
            'Key Contacts': kyb_data.get('key_contacts', 'N/A') + ' [Generated by Groq LLM]',
            'Social Media Links': json.dumps(scraped_data.get('social_media', {})) + f' [Scraped from {company_website}]',
            'AI Model Used': kyb_data.get('ai_models', 'N/A') + ' [Generated by Groq LLM]',
            'Primary AI Use Case': kyb_data.get('ai_use_case', 'N/A') + ' [Generated by Groq LLM]',
            'AI Frameworks Used': kyb_data.get('ai_frameworks', 'N/A') + ' [Generated by Groq LLM]',
            'AI Products/Services Offered': kyb_data.get('ai_products', 'N/A') + ' [Generated by Groq LLM]',
            'Patent Details': kyb_data.get('patents', 'N/A') + ' [Generated by Groq LLM]',
            'AI Research Papers Published': kyb_data.get('research_papers', 'N/A') + ' [Generated by Groq LLM]',
            'Partnerships': kyb_data.get('partnerships', 'N/A') + ' [Generated by Groq LLM]',
            'Technology Stack': kyb_data.get('tech_stack', 'N/A') + ' [Generated by Groq LLM]',
            'Customer Base': kyb_data.get('customers', 'N/A') + ' [Generated by Groq LLM]',
            'Case Studies': kyb_data.get('case_studies', 'N/A') + ' [Generated by Groq LLM]',
            'Awards and Recognition': kyb_data.get('awards', 'N/A') + ' [Generated by Groq LLM]',
            'Compliance and Regulatory Adherence': kyb_data.get('compliance', 'N/A') + ' [Generated by Groq LLM]',
            'Market Presence': kyb_data.get('market_presence', 'N/A') + ' [Generated by Groq LLM]',
            'Community Engagement': kyb_data.get('community', 'N/A') + ' [Generated by Groq LLM]',
            'AI Ethics Policies': kyb_data.get('ethics', 'N/A') + ' [Generated by Groq LLM]',
            'Competitor Analysis': kyb_data.get('competitors', 'N/A') + ' [Generated by Groq LLM]',
            'Media Mentions': kyb_data.get('media', 'N/A') + ' [Generated by Groq LLM]'
        }

        # Check if company exists
        company_idx = df[df['Company Name'].str.lower() == company_name.lower()].index
        
        if len(company_idx) > 0:
            # Update existing company
            for key, value in new_data.items():
                df.at[company_idx[0], key] = value
        else:
            # Add new company
            df = pd.concat([df, pd.DataFrame([new_data])], ignore_index=True)
        
        # Save updated database
        df.to_csv("knowYourAi - Company Details.csv", index=False)
        return True
...
def check_company_data(company_name):
